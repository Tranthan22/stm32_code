...
const uint8_t macaddr [6] = {0x01,0x05,0x20,0x07,0x19,0x98};
uint8_t ip [4] = {192,168,0,123};
...
void ENC29J600_ini(SPI_HandleTypeDef *spi)
{
 ...
 else
 {
    ...
    HAL_Delay(1);
    ENC28J60_write_command (ENC28J60_BIT_FIELD_SET, ECON1, ECON1_RXEN); // cho ph�p nhan g�i
 }
}
